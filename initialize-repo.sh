...
echo
echo Continue to create GitHub TAP GitOps Repo tap-gitops-aks
echo     https://github.com/bkirkware/tap-gitops-aks
echo
...
git add .
git commit -am "."
gh repo create tap-gitops-aks --private
git remote add origin https://github.com/bkirkware/tap-gitops-aks
git branch -M main
